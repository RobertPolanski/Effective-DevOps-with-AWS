...
ApplicationName = "Chapter03/ansible/helloworld/helloworld"
ApplicationPort = "3000"
GithubAccount = "RobertPolanski"
GithubAnsibleURL = "https://github.com/{}/Effective-DevOps-with-AWS-Second-Edition".format(GithubAccount)
